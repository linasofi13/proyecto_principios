...
public class Cuenta {
    ...
    public Cuenta(String nombreCuenta, String correoElectronico, String contrasena, int nivelJugador, int cantidadExp, int cantidadSoles) {
    ...
    public String toString(){
        String infoCuenta= "Usuario: "+this.getNombreCuenta()+" | Correo Electronico: "+this.getCorreoElectronico()+" | Contraseña: "+ this.getContrasena()+
    ...
    public static void visualizarInstrucciones() {
        ...
        System.out.println("-Si tu planta tiene muchas plagas, debes desparasitarla ---> (esto hará que tu planta disminuya la cantidad de sol porque la quitaste del patio para desparasitarla)");
    ...
    public static void aumentarNivel(){
        int requisito = 100;
        if(Principal.cuentas.get(0).getCantidadExp() >= requisito){
            requisito += 50;
            Principal.cuentas.get(0).setNivelJugador(Principal.cuentas.get(0).getNivelJugador() + 1);
        }
    }
